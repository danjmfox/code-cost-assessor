...
describe('detectSessions', () => {
  it('groups consecutive commits within the gap into one session', () => {
    const commits = [
      commit('a', 1714000000),
  ...
  it('splits commits separated by more than gapSeconds into different sessions', () => {
    const commits = [
      commit('a', 1714000000),
  ...
  it('a single commit produces one session', () => {
  ...
  it('returns sessions in chronological order (oldest first)', () => {
    const commits = [
      commit('a', 1714000000),
      commit('b', 1714020000),
      commit('c', 1714030000),
  ...
  it('Spike D ground truth: 3h gap produces 15-22 sessions on realistic repo', () => {
